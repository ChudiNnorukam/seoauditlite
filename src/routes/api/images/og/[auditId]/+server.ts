                          ...
                          children: [
                            // Pass badge
                            {
                              ...
                              props: {
                                ...
                                children: [
                                  { type: 'span', props: { style: { color: '#16a34a', fontWeight: 700, fontSize: '16px' }, children: `${data.passes} pass` } },
                                ],
                              },
                            },
                            // Warning badge
                            {
                              ...
                              props: {
                                ...
                                children: [
                                  { type: 'span', props: { style: { color: '#ca8a04', fontWeight: 700, fontSize: '16px' }, children: `${data.warnings} warn` } },
                                ],
                              },
                            },
                            // Fail badge
                            {
                              ...
                              props: {
                                ...
                                children: [
                                  { type: 'span', props: { style: { color: '#dc2626', fontWeight: 700, fontSize: '16px' }, children: `${data.fails} fail` } },
                                ],
                              },
                            },
                          ],
